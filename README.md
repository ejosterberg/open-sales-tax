...
[![DOR-validated](https://img.shields.io/badge/DOR--validated-309%2F309_ZIPs-brightgreen)](tests/integration/test_sst_dor_validation.py)
...
**309 ZIPs validated against published state DOR rates** on every
...
# {"status":"ok","version":"0.48.0","database_connected":true}
```
