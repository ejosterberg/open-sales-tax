...
[![DOR-validated](https://img.shields.io/badge/DOR--validated-322%2F322_ZIPs-brightgreen)](tests/integration/test_sst_dor_validation.py)
...
**322 ZIPs validated against published state DOR rates** on every
...
# {"status":"ok","version":"0.53.1","database_connected":true}
```
