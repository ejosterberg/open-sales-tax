...
[![DOR-validated](https://img.shields.io/badge/DOR--validated-312%2F312_ZIPs-brightgreen)](tests/integration/test_sst_dor_validation.py)
...
**312 ZIPs validated against published state DOR rates** on every
...
# {"status":"ok","version":"0.49.0","database_connected":true}
```
