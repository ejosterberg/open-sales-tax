...
| Tennessee | TN | _vacant — see issue tracker_ | _v0.11 (SST associate-member tier-2 -> tier-1 promotion; 7.0% state per Tenn. Code Ann. § 67-6-202; reduced 4.0% state grocery rate per Tenn. Code Ann. § 67-6-228 encoded via rate_modifier=Decimal("4.000"); annual back-to-school holiday under § 67-6-393 with 4 scopes (clothing/$100, school supplies/$100, school art supplies/$100, computers/$1500))_ |
...
(AR, GA, IA, IN promoted in v0.8; KS, KY, MI, NE, NV in v0.9; NC, ND, NJ, OH, OK in v0.10; TN in v0.11 -- see the table above.)

If you'd like to upgrade your state to tier 1, please open an issue.

States: RI, SD, UT, VT, WA, WV, WY.
