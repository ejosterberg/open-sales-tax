...
| Kentucky | KY | _vacant — see issue tracker_ | _v0.8 (SST tier-2 -> tier-1 promotion; state-only -- KY levies no local sales tax)_ |
...
(AR, GA, IA, IN, and KY were promoted to tier 1 in v0.8 -- see the table above.)

If you'd like to upgrade your state to tier 1, please open an issue.

States: KS, MI, NE, NV, NJ, NC, ND, OH, OK, RI,
