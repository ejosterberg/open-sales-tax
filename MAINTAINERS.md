...
| South Dakota | SD | _vacant — see issue tracker_ | _v0.11 (SST tier-2 -> tier-1 promotion; 4.2% per SDCL § 10-45-2 with statutory sunset 2027-06-30 reverting to 4.5% per HB 1137 of 2023; groceries FULLY TAXABLE per SDCL § 10-45-2.4 -- notable peer-state difference; plaintiff in South Dakota v. Wayfair, 138 S. Ct. 2080 (2018) which established economic-nexus standards nationwide; no state sales-tax holiday)_ |
...
(AR, GA, IA, IN promoted in v0.8; KS, KY, MI, NE, NV in v0.9; NC, ND, NJ, OH, OK in v0.10; SD in v0.11 -- see the table above.)

If you'd like to upgrade your state to tier 1, please open an issue.

States: RI, TN, UT, VT, WA, WV, WY.
