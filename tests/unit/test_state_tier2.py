...
Utah (UT) was promoted in v0.11 (Phase 7 Batch P4). They now
...
# All 7 tier-2 states should be present (AR+GA+IA+IN+KS+KY+MI+NC+ND+NE+NJ+NV+OH+OK promoted to tier 1 in v0.8/v0.9/v0.10; UT promoted in v0.11).
...
def test_phase_1_states_all_registered() -> None:
    ...
    # 7 tier-2 + MN+WI+AR+GA+IA+IN+KS+KY+MI+NC+ND+NE+NJ+NV+OH+OK+UT (tier 1 SST) + AK, DE, MT, NH, OR (no-tax)
