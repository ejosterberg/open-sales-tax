...
promoted to tier 1 in v0.8; Michigan (MI) was promoted to tier 1
in v0.9. They now live in their dedicated modules under
``opensalestax/states/``.
"""
...
# All 17 tier-2 states should be present (AR + GA + IA + IN promoted to
# tier 1 in v0.8; MI promoted to tier 1 in v0.9).
...
def test_phase_1_states_all_registered() -> None:
    ...
    # 17 tier-2 + MN + WI + AR + GA + IA + IN + MI (tier 1 SST) + AK, DE, MT, NH, OR (no-tax)
