...
promoted to tier 1 in v0.8; Nebraska (NE) was promoted in the
v0.8.x ratchet. They now live in their dedicated modules under
``opensalestax/states/``.
"""
...
# All 17 tier-2 states should be present (AR + GA + IA + IN + NE were
# promoted to tier 1 in v0.8 / v0.8.x).
...
def test_phase_1_states_all_registered() -> None:
    ...
    # 17 tier-2 + MN + WI + AR + GA + IA + IN + NE (tier 1 SST) + AK, DE, MT, NH, OR (no-tax)
