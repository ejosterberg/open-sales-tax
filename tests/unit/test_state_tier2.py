...
# All 21 tier-2 states should be present (IA promoted to tier 1 in v0.7.x).
...
def test_phase_1_states_all_registered() -> None:
    ...
    # 21 tier-2 + MN + WI + IA (tier 1 SST) + AK, DE, MT, NH, OR (no-tax) = 29
    expected = EXPECTED_TIER_2_ABBREVS | {"MN", "WI", "IA", "AK", "DE", "MT", "NH", "OR"}
