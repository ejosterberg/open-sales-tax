...
and New Jersey (NJ) were promoted to tier 1 in v0.8/v0.9/v0.10;
...
# All 12 tier-2 states should be present (AR+GA+IA+IN+KS+KY+MI+NE+NJ+NV were promoted to tier 1 in v0.8/v0.9/v0.10).
...
def test_phase_1_states_all_registered() -> None:
    ...
    # 12 tier-2 + MN+WI+AR+GA+IA+IN+KS+KY+MI+NE+NJ+NV (tier 1 SST) + AK, DE, MT, NH, OR (no-tax)
