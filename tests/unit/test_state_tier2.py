...
(NV) were promoted to tier 1 in v0.8/v0.9. North Carolina (NC)
was promoted to tier 1 in the Phase 7 SST ratchet. They now
...
# All 12 tier-2 states should be present (AR+GA+IA+IN+KS+KY+MI+NC+NE+NV were promoted to tier 1 in v0.8/v0.9 + Phase 7 SST ratchet).
...
def test_phase_1_states_all_registered() -> None:
    ...
    # 12 tier-2 + MN+WI+AR+GA+IA+IN+KS+KY+MI+NC+NE+NV (tier 1 SST) + AK, DE, MT, NH, OR (no-tax)
