...
Generated from the Census Bureau ZCTA->County 2020 relationship file
(public domain). Covers all 3,000+ US county-equivalents (50 states +
DC + PR + USVI + Guam + American Samoa + Northern Mariana Islands).

Used by SST state modules to translate the SST file's 3-digit county
FIPS code into a friendly name like 'Hennepin County' or 'Orleans
Parish' for the engine's per-jurisdiction breakdown response. The
name includes the canonical local suffix that appears on receipts.

Regenerate via scripts/regen_county_names.py if the Census 2030 file
renames or adds counties.
"""
...
COUNTY_NAMES: dict[tuple[str, str], str] = {
    ...
    ("AL", "003"): "Baldwin County",
    ("AL", "005"): "Barbour County",
    ("AL", "007"): "Bibb County",
    ("AL", "009"): "Blount County",
    ("AL", "011"): "Bullock County",
    ("AL", "013"): "Butler County",
    ("AL", "015"): "Calhoun County",
    ("AL", "017"): "Chambers County",
    ("AL", "019"): "Cherokee County",
    ("AL", "021"): "Chilton County",
    ("AL", "023"): "Choctaw County",
    ("AL", "025"): "Clarke County",
    ("AL", "027"): "Clay County",
    ("AL", "029"): "Cleburne County",
    ("AL", "031"): "Coffee County",
    ("AL", "033"): "Colbert County",
    ("AL", "035"): "Conecuh County",
    ("AL", "037"): "Coosa County",
    ("AL", "039"): "Covington County",
    ("AL", "041"): "Crenshaw County",
    ("AL", "043"): "Cullman County",
    ("AL", "045"): "Dale County",
    ("AL", "047"): "Dallas County",
    ("AL", "049"): "DeKalb County",
    ("AL", "051"): "Elmore County",
    ("AL", "053"): "Escambia County",
    ("AL", "055"): "Etowah County",
    ("AL", "057"): "Fayette County",
    ("AL", "059"): "Franklin County",
    ("AL", "061"): "Geneva County",
    ("AL", "063"): "Greene County",
    ("AL", "065"): "Hale County",
    ("AL", "067"): "Henry County",
    ("AL", "069"): "Houston County",
    ("AL", "071"): "Jackson County",
    ("AL", "073"): "Jefferson County",
    ("AL", "075"): "Lamar County",
    ("AL", "077"): "Lauderdale County",
    ("AL", "079"): "Lawrence County",
    ("AL", "081"): "Lee County",
    ("AL", "083"): "Limestone County",
    ("AL", "085"): "Lowndes County",
    ("AL", "087"): "Macon County",
    ("AL", "089"): "Madison County",
    ("AL", "091"): "Marengo County",
    ("AL", "093"): "Marion County",
    ("AL", "095"): "Marshall County",
    ("AL", "097"): "Mobile County",
    ("AL", "099"): "Monroe County",
    ("AL", "101"): "Montgomery County",
    ("AL", "103"): "Morgan County",
    ("AL", "105"): "Perry County",
    ("AL", "107"): "Pickens County",
    ("AL", "109"): "Pike County",
    ("AL", "111"): "Randolph County",
    ("AL", "113"): "Russell County",
    ("AL", "115"): "St. Clair County",
    ("AL", "117"): "Shelby County",
    ("AL", "119"): "Sumter County",
    ("AL", "121"): "Talladega County",
    ("AL", "123"): "Tallapoosa County",
    ("AL", "125"): "Tuscaloosa County",
    ...
    ("PR", "075"): "Juana Díaz Municipio",
    ("PR", "077"): "Juncos Municipio",
    ("PR", "079"): "Lajas Municipio",
    ("PR", "081"): "Lares Municipio",
    ("PR", "083"): "Las Marías Municipio",
    ("PR", "085"): "Las Piedras Municipio",
    ("PR", "087"): "Loíza Municipio",
    ("PR", "089"): "Luquillo Municipio",
    ("PR", "091"): "Manatí Municipio",
    ("PR", "093"): "Maricao Municipio",
    ("PR", "095"): "Maunabo Municipio",
    ("PR", "097"): "Mayagüez Municipio",
