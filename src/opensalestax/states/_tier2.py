...
KS, KY, MI, NC, ND, NE, NJ, NV, OH, OK, WY are now tier 1). Each is
a ~10-line subclass of :class:`SstStateModule` providing only the
...
# (OK), and Wyoming (WY) were promoted to tier 1 in
# v0.8/v0.9/v0.10/v0.11 -- see their dedicated modules in
# ``opensalestax/states/``. WY's promotion in v0.11 completed the SST
# tier-2 -> tier-1 ratchet (Phase 7 milestone -- every SST member
# state now ships a fully-maintained taxability matrix).
# ---------------------------------------------------------------------------
