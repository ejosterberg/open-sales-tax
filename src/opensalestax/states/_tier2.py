...
The 17 SST members not yet promoted to tier 1 (MN, WI, AR, GA, IA, IN, NE
...
# ``opensalestax/states/``. Nebraska (NE) was promoted to tier 1
# in the v0.8.x ratchet (Phase 7) -- see ``nebraska.py``.
# ---------------------------------------------------------------------------
