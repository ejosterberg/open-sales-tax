...
KY are now tier 1). Each is a ~10-line subclass of :class:`SstStateModule`
...
#
# Arkansas (AR), Georgia (GA), Indiana (IN), Iowa (IA), and Kentucky
# (KY) were promoted to tier 1 in v0.8 -- see their dedicated modules
# in ``opensalestax/states/``.
# ---------------------------------------------------------------------------
