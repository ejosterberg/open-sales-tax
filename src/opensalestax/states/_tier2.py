...
KS, KY, MI, NC, ND, NE, NJ, NV, OH, OK, UT are now tier 1). Each is a
~10-line subclass of :class:`SstStateModule` providing only the state-
specific metadata (USPS abbreviation, full name, state FIPS).
...
# (OK), and Utah (UT) were promoted to tier 1 in v0.8/v0.9/v0.10/v0.11
