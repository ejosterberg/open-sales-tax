...
The 11 SST members not yet promoted to tier 1 (MN, WI, AR, GA, IA, IN,
KS, KY, MI, ND, NE, NJ, NV are now tier 1). Each is a ~10-line subclass of
...
# ---------------------------------------------------------------------------
# 11 tier-2 SST states. Order roughly alphabetical for readability.
# Sources:
...
# (NJ), and North Dakota (ND) were promoted to tier 1 in v0.8/v0.9/v0.10
# -- see their dedicated modules in ``opensalestax/states/``.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Register all 11 instances at import time
# ---------------------------------------------------------------------------
